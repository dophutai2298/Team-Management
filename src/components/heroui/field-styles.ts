...
export const selectFieldClassNames = {
  ...
  mainWrapper: "w-full",
  trigger:
    "h-12 min-h-12 w-full rounded-lg border border-line bg-panel px-3 shadow-none outline-none transition-[border-color,box-shadow,background-color] data-[hover=true]:border-primary/55 data-[focus=true]:border-primary data-[focus=true]:shadow-[0_0_0_3px_rgb(79_70_229_/_0.16)] data-[focus-visible=true]:outline-none data-[open=true]:border-primary data-[open=true]:shadow-[0_0_0_3px_rgb(79_70_229_/_0.16)] group-data-[invalid=true]:border-danger",
  value:
    "w-full text-left text-sm font-medium leading-5 text-ink group-data-[has-value=true]:text-ink",
